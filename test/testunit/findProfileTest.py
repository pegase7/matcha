...
class FindProfileTestCase(unittest.TestCase):
    ...
    def runTest(self):
        ...
        logging.info('   +-------------------+')
        self.set_criteres(1, 10,'Female', None, None, 0, 100, 2000, [], [13,2,24,23,18])
        self.set_criteres(2, 10,'Female', None, None, 0, 100, 20000, [], [13,2,11,24,23,18])
        ...
        self.set_criteres(5, 10,'Female', None, None, 0, 100, 2000, ['Photographie', 'Cuisine', 'Television'], [13,23,24])
        self.set_criteres(6, 18,'Female', None, None, 0, 100, 2000, [], [14,17])
        self.set_criteres(7, 18,'Female', 25, 50, 0, 100, 2000, [], [14])
        ...
        self.set_criteres(11, 18,'Female', 18, 50, 0, 100, 2000, ['Photographie', 'Nature'], [14, 17])
        self.set_criteres(12, 14,'Female', None, None, 0, 100, 20000, [], [18, 17])
        self.set_criteres(13, 14,'Female', None, None, 0, 100, 20000, ['Danse'], [])
        self.set_criteres(14, 14,'Female', 18, 50, 20, 100, 20000, [], [18, ])
        self.set_criteres(15, 19,'Female', None, None, 0, 100, 2000, [], [13,2,24,23,18])
        ...
        self.set_criteres(19, 15,'Female', 18, 50, 0, 100, 2000, [], [23, 18])
        self.set_criteres(20, 15,'Female', None, None, 0, 100, 2000, ['Gastronomie'], [23,24])
        self.set_criteres(21, 15,'Female', 30, 50, 0, 100, 20000, [], [6,11,23])
