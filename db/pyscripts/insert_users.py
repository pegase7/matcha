...
def compute_users(users, coordsize):
...
def populate():    
    ...
    for _ in range(1000):
        ...
        complete_users(female, fake, coordsize)
        userslist.append(female)
        male = Users()
        male.gender = 'Male'
        male.first_name = fake.first_name_male()
        complete_users(male, fake, coordsize)
